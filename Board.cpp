...
//             FootSoldier::Fight_foot(board, p);
//         }
//         if (dynamic_cast<FootCommander *>(pSoldier)) {
//             FootCommander::Fight_Cfoot(Board::board, p);
//
//         }
//         if (dynamic_cast<Sniper *>(pSoldier)) {
//             Sniper::Fight_sniper(Board::board, p);
//
//         }
//         if (dynamic_cast<SniperCommander *>(pSoldier)) {
//             SniperCommander::Fight_Csniper(Board::board, p);
//
//         }
//         if (dynamic_cast<Parmedic *>(pSoldier)) {
//             Parmedic::to_heal_peramdic(Board::board, p);
//
//         }
//         if (dynamic_cast<ParmedicCommander *>(pSoldier)) {
//             ParmedicCommander::to_heal_Cperamdic(Board::board, p);
//         }
//     }
//
