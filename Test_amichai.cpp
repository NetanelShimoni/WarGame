...
TEST_CASE ("3 VS 3") {
   ...
   board.move(1, {0, 1}, WarGame::Board::MoveDIR::Up); //player 2 footsoldier1 - 90
    ...
    board.move(1, {0, 0},
               WarGame::Board::MoveDIR::Up);//player 2 commanderSoldier - 130, player 2 footsoldier1 - 70,   player 2 footsoldier2 - 90,
...
board.printboard();
   ...
   // board.move(1, {0, 1}, WarGame::Board::MoveDIR::Up);//player2 soldier2 - 130, player 2 soldier1 - 80
    ...
    board.printboard();
    board.move(1, {0, 3},
               WarGame::Board::MoveDIR::Up); //player2 soldier4 - 20, player2 soldier3 - 50 //need to define to check the closes when there are equalh healh points
            CHECK(board.has_soldiers(2));
    board.printboard();
    ...
    board.printboard();//player2 soldier3 - 0, player2 soldier 6 - 20/10
    board.move(1, {0, 2}, WarGame::Board::MoveDIR::Up);
    board.printboard();; //player2 soldier3 - 0, player2 soldier 6 - 0
    board.move(1, {1, 2}, WarGame::Board::MoveDIR::Down);
    board.printboard();//player2 soldier3 - 0, player2 soldier 6 - 0
    board.move(1, {0, 2}, WarGame::Board::MoveDIR::Up);
    board.printboard();//player2 soldier3 - 0, player2 soldier 6 - 0
